...
type Endpoint9_0Request = Parameters<RawClient["server.omniRouter"]["omniRouter.config"]>[0]
type Endpoint9_0Input = { readonly location?: Endpoint9_0Request["query"]["location"] }
const Endpoint9_0 = (raw: RawClient["server.omniRouter"]) => (input?: Endpoint9_0Input) =>
  raw["omniRouter.config"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint9_1Request = Parameters<RawClient["server.omniRouter"]["omniRouter.setConfig"]>[0]
type Endpoint9_1Input = {
  readonly location?: Endpoint9_1Request["query"]["location"]
  readonly enabled?: Endpoint9_1Request["payload"]["enabled"]
  readonly baseURL?: Endpoint9_1Request["payload"]["baseURL"]
  readonly strategy?: Endpoint9_1Request["payload"]["strategy"]
}
const Endpoint9_1 = (raw: RawClient["server.omniRouter"]) => (input?: Endpoint9_1Input) =>
  raw["omniRouter.setConfig"]({
    query: { location: input?.["location"] },
    payload: { enabled: input?.["enabled"], baseURL: input?.["baseURL"], strategy: input?.["strategy"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint9_2Request = Parameters<RawClient["server.omniRouter"]["omniRouter.list"]>[0]
type Endpoint9_2Input = { readonly location?: Endpoint9_2Request["query"]["location"] }
const Endpoint9_2 = (raw: RawClient["server.omniRouter"]) => (input?: Endpoint9_2Input) =>
  raw["omniRouter.list"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint9_3Request = Parameters<RawClient["server.omniRouter"]["omniRouter.get"]>[0]
type Endpoint9_3Input = {
  readonly keyID: Endpoint9_3Request["params"]["keyID"]
  readonly location?: Endpoint9_3Request["query"]["location"]
}
const Endpoint9_3 = (raw: RawClient["server.omniRouter"]) => (input: Endpoint9_3Input) =>
  raw["omniRouter.get"]({ params: { keyID: input["keyID"] }, query: { location: input["location"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint9_4Request = Parameters<RawClient["server.omniRouter"]["omniRouter.add"]>[0]
type Endpoint9_4Input = {
  readonly location?: Endpoint9_4Request["query"]["location"]
  readonly key: Endpoint9_4Request["payload"]["key"]
  readonly label?: Endpoint9_4Request["payload"]["label"]
  readonly limit?: Endpoint9_4Request["payload"]["limit"]
}
const Endpoint9_4 = (raw: RawClient["server.omniRouter"]) => (input: Endpoint9_4Input) =>
  raw["omniRouter.add"]({
    query: { location: input["location"] },
    payload: { key: input["key"], label: input["label"], limit: input["limit"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint9_5Request = Parameters<RawClient["server.omniRouter"]["omniRouter.update"]>[0]
type Endpoint9_5Input = {
  readonly keyID: Endpoint9_5Request["params"]["keyID"]
  readonly location?: Endpoint9_5Request["query"]["location"]
  readonly label?: Endpoint9_5Request["payload"]["label"]
  readonly enabled?: Endpoint9_5Request["payload"]["enabled"]
  readonly limit?: Endpoint9_5Request["payload"]["limit"]
}
const Endpoint9_5 = (raw: RawClient["server.omniRouter"]) => (input: Endpoint9_5Input) =>
  raw["omniRouter.update"]({
    params: { keyID: input["keyID"] },
    query: { location: input["location"] },
    payload: { label: input["label"], enabled: input["enabled"], limit: input["limit"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint9_6Request = Parameters<RawClient["server.omniRouter"]["omniRouter.remove"]>[0]
type Endpoint9_6Input = {
  readonly keyID: Endpoint9_6Request["params"]["keyID"]
  readonly location?: Endpoint9_6Request["query"]["location"]
}
const Endpoint9_6 = (raw: RawClient["server.omniRouter"]) => (input: Endpoint9_6Input) =>
  raw["omniRouter.remove"]({ params: { keyID: input["keyID"] }, query: { location: input["location"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint9_7Request = Parameters<RawClient["server.omniRouter"]["omniRouter.rotate"]>[0]
type Endpoint9_7Input = { readonly location?: Endpoint9_7Request["query"]["location"] }
const Endpoint9_7 = (raw: RawClient["server.omniRouter"]) => (input?: Endpoint9_7Input) =>
  raw["omniRouter.rotate"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint9_8Request = Parameters<RawClient["server.omniRouter"]["omniRouter.resetUsage"]>[0]
type Endpoint9_8Input = {
  readonly keyID: Endpoint9_8Request["params"]["keyID"]
  readonly location?: Endpoint9_8Request["query"]["location"]
}
const Endpoint9_8 = (raw: RawClient["server.omniRouter"]) => (input: Endpoint9_8Input) =>
  raw["omniRouter.resetUsage"]({ params: { keyID: input["keyID"] }, query: { location: input["location"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint9_9Request = Parameters<RawClient["server.omniRouter"]["omniRouter.stats"]>[0]
type Endpoint9_9Input = { readonly location?: Endpoint9_9Request["query"]["location"] }
const Endpoint9_9 = (raw: RawClient["server.omniRouter"]) => (input?: Endpoint9_9Input) =>
  raw["omniRouter.stats"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup9 = (raw: RawClient["server.omniRouter"]) => ({
  config: Endpoint9_0(raw),
  setConfig: Endpoint9_1(raw),
  list: Endpoint9_2(raw),
  get: Endpoint9_3(raw),
  add: Endpoint9_4(raw),
  update: Endpoint9_5(raw),
  remove: Endpoint9_6(raw),
  rotate: Endpoint9_7(raw),
  resetUsage: Endpoint9_8(raw),
  stats: Endpoint9_9(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  omniRouter: adaptGroup9(raw["server.omniRouter"]),
